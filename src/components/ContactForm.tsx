...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Algo salio mal. Intentalo nuevamente.",
        className: cn(
  ...
  return (
    <form className="min-w-7xl mx-auto sm:mt-4" onSubmit={handleSubmit} aria-busy={loading}>
      ...
      <div className="grid w-full gap-1.5 mb-4">
        ...
        <Textarea
          placeholder="Cuentame sobre la oportunidad, practica o proyecto backend."
          id="content"
          value={message}
        ...
        <p className="text-sm text-muted-foreground">
          Usare tus datos solo para responder este mensaje.
        </p>
      </div>
      <Button
        disabled={loading}
