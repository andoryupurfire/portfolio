...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "Spring",
    shortDescription: "APIs backend con Spring Boot.",
    color: "#6db33f",
  ...
  [SkillNames.VUE]: {
    ...
    name: "vue",
    label: "Security",
    shortDescription: "Autenticacion y permisos.",
    color: "#6db33f",
    icon: `${DEVICON}/spring/spring-original.svg`,
  },
  [SkillNames.NEXTJS]: {
    ...
    name: "nextjs",
    label: "REST",
    shortDescription: "Endpoints claros por recurso.",
    color: "#ffffff",
  ...
  [SkillNames.TAILWIND]: {
    ...
    name: "tailwind",
    label: "Tailwind",
    shortDescription: "Estilos rapidos y consistentes.",
    color: "#38bdf8",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "JPA",
    shortDescription: "Persistencia y repositorios.",
    color: "#6db33f",
    icon: `${DEVICON}/spring/spring-original.svg`,
  },
  [SkillNames.EXPRESS]: {
  ...
  [SkillNames.POSTGRES]: {
    ...
    name: "postgres",
    label: "Postgres",
    shortDescription: "Base relacional para backend.",
    color: "#336791",
  ...
  [SkillNames.PRETTIER]: {
    ...
    name: "prettier",
    label: "Swagger",
    shortDescription: "Docs claras para APIs.",
    color: "#85ea2d",
  ...
  [SkillNames.LINUX]: {
    ...
    name: "linux",
    label: "JUnit",
    shortDescription: "Pruebas automatizadas.",
    color: "#25a162",
  ...
  [SkillNames.DOCKER]: {
    ...
    name: "docker",
    label: "Docker",
    shortDescription: "Contenedores y despliegue.",
    color: "#2496ed",
  ...
  [SkillNames.GCP]: {
    ...
    name: "gcp",
    label: "Supabase",
    shortDescription: "Postgres gestionado.",
    color: "#3ecf8e",
  ...
  [SkillNames.VERCEL]: {
    ...
    name: "vercel",
    label: "Practicas",
    shortDescription: "Capas, errores y DTOs.",
    color: "#ffffff",
